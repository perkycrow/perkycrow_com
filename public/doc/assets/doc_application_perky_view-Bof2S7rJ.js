import { d as doc, t as text, s as section, a as code } from "./runtime-29XJHD7V.js";
const perky_view_doc = doc("PerkyView", () => {
  text(`
  ...
  section("Creation", () => {
    ...
    code("Basic creation", () => {
      ...
      console.log(view.element.tagName);
    });
  ...
  section("CSS Classes", () => {
    ...
    code("addClass / removeClass / hasClass", () => {
      ...
      console.log(view.hasClass("active"));
