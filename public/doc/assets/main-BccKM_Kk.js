const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["./doc_application_application-BDuVJ8UP.js","./runtime-xB3_cpHX.js","./logger-Wk9ggM8V.js","./notifier-BaRt7qG0.js","./doc_application_perky_view-WQ4oC7W2.js","./doc_audio_audio_system-DqNBjhSS.js","./audio_system-CRnQ_87z.js","./perky_module-BD8xZ4RH.js","./registry-DkFDcuAy.js","./observable_map-DbdPsVuP.js","./observable_set-CjEWA0bY.js","./utils-1YvUtnPG.js","./inflector--UCXb4XA.js","./doc_core_action_controller-DR3BIb3G.js","./action_controller-D-4twAJQ.js","./doc_core_action_dispatcher-phzEI6dO.js","./action_dispatcher-ZNfZMYqj.js","./doc_core_inflector-BhQ5hXSK.js","./doc_core_logger-Ccf9ubjC.js","./doc_core_notifier-CIbKJZ2e.js","./doc_core_observable_map-_kWOdv5v.js","./doc_core_observable_set-DRkrptWJ.js","./doc_core_perky_module-CBCbshC_.js","./doc_core_perky_query-Ojz2K6JI.js","./doc_core_registry-BHfRu3rP.js","./doc_core_utils-GvgJvN_1.js","./doc_editor_inspectors_action_controller_inspector-0x_SDt8G.js","./action_controller_inspector-BzsNxuJM.js","./perky_explorer_details-blS-_Re2.js","./perky_explorer_styles-C0ezRuWU.js","./doc_editor_inspectors_action_dispatcher_inspector-ez9-EqBL.js","./action_dispatcher_inspector-CRxcycCE.js","./toggle_input-Do276pUG.js","./base_input-C1WyeWNO.js","./doc_editor_log_renderers_vec2_log_renderer-DTC_6qJu.js","./vec2-BvD8ope7.js","./vec2_log_renderer-CHeUJOoI.js","./doc_editor_perky_explorer-D6j6atQI.js","./keyboard_device-DYWAPKqs.js","./button_control-4gs7TZGw.js","./input_control-Bm8lg0DB.js","./mouse_device-7lLdft0L.js","./vec2_control-89KZna8m.js","./game_loop-DovgaDSG.js","./canvas_2d-Yt-LAEP6.js","./group_2d-Cw-ZHZml.js","./webgl_canvas_2d-De5HD5D0.js","./vec2_input-BFMiN3vt.js","./doc_editor_perky_logger-Cw4GdhTF.js","./doc_editor_toggle_input-XeOnmYLO.js","./doc_editor_vec2_input-FaJpPSLh.js","./doc_game_game-DHG5e4qr.js","./doc_game_game_loop-60dMEHIq.js","./doc_input_input_control-t2ssK_ay.js","./doc_input_input_controls_vec2_control-DSx6-rXj.js","./doc_input_input_devices_keyboard_device-MVQ-KN8-.js","./doc_input_input_devices_mouse_device-F2ZfT00c.js","./doc_math_random-g0gJo4gn.js","./doc_math_vec2-CifAhRWd.js","./doc_render_canvas_2d-DHWJHfNx.js","./doc_render_webgl_canvas_2d-CgfpWz2C.js","./conventions.guide-nXQ1XJTJ.js","./perky_module.guide-NAWFJZFK.js","./foreword.guide-DLfyd409.js","./philosophy.guide-0HEdzMHo.js"])))=>i.map(i=>d[i]);
...
import { t as toKebabCase, a as toHumanCase } from "./utils-1YvUtnPG.js";
import { a as applyContainerPreset } from "./runtime-xB3_cpHX.js";
...
function parseMarkdown(text, options = {}) {
  const { buildSeeUrl: buildSeeUrl2 = defaultBuildSeeUrl } = options;
  return text.replace(/`([^`]+)`/g, "<code>$1</code>").replace(/\*\*([^*]+)\*\*/g, "<strong>$1</strong>").replace(/\*([^*]+)\*/g, "<em>$1</em>").replace(/\[\[([^\]]+)\]\]/g, (_, ref) => parseSeeLink(ref, buildSeeUrl2)).split("\n\n").filter((p) => p.trim()).map((p) => renderBlock(p.trim())).join("");
}
...
function parseSeeLink(ref, buildSeeUrl2) {
  let name = ref;
  let pageType = "doc";
  let section = null;
  let category = null;
  ...
  const url = buildSeeUrl2(name, pageType, section, category);
