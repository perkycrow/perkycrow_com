...
var _actions, _actionList, _engine, _ActionController_instances, defineResourceGetters_fn;
...
const _ActionController = class _ActionController extends PerkyModule {
  ...
  get engine() {
    var _a, _b;
    return __privateGet(this, _engine) ?? ((_a = this.host) == null ? void 0 : _a.engine) ?? ((_b = this.host) == null ? void 0 : _b.host) ?? this.host;
  }
  set engine(value) {
  ...
  for (const name of this.constructor.resources) {
    if (this[name] === void 0) {
      ...
      Object.defineProperty(this, name, {
        get: () => {
          var _a;
          return override === void 0 ? (_a = this.engine) == null ? void 0 : _a[name] : override;
        },
        set: (value) => {
          override = value;
        },
