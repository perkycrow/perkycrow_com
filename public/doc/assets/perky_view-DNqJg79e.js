...
var _bindings, _InputSystem_instances, getControlsFromBinding_fn, initEvents_fn, handleInputEvent_fn, _resizeObserver, _previousStyles, _onFullscreenChange, _previousDisplay, _PerkyView_instances, setupResizeObserver_fn, setupFullscreenEvents_fn, requestFullscreen_fn, dispatchDisplayModeChanged_fn;
import { P as PerkyModule } from "./perky_module-BJShv6RO.js";
import { R as Registry } from "./registry-DalNpkO9.js";
import { K as KeyboardDevice } from "./keyboard_device-DYYCSMin.js";
import { M as MouseDevice } from "./mouse_device-T58tKAHV.js";
import { T as TouchDevice } from "./touch_device-B-huuOQs.js";
import { V as Vec2 } from "./vec2-BvD8ope7.js";
import { u as uniqueId } from "./utils-CPyB8f8f.js";
class InputBinding {
  constructor({
    deviceName,
    controlName,
