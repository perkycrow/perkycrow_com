...
class AudioSource extends PerkyModule {
  ...
  fadeIn(duration = 1) {
    var _a;
    if (!__privateGet(this, _gainNode2) || !((_a = __privateGet(this, _audioContext2)) == null ? void 0 : _a.context)) {
      return this;
    }
...
updatePannerPosition_fn = function() {
  var _a;
  if (__privateGet(this, _pannerNode) && ((_a = __privateGet(this, _audioContext2)) == null ? void 0 : _a.context)) {
    const ctx = __privateGet(this, _audioContext2).context;
