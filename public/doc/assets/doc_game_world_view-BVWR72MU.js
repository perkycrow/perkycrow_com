...
import { d as doc, t as text, s as section, f as container, c as code } from "./runtime-DVl2nrG4.js";
import { P as PerkyModule } from "./perky_module-H-JzEFBm.js";
import { W as WorldView, E as Entity, a as EntityView } from "./entity-Yk-cDJQd.js";
...
class World extends PerkyModule {
  ...
  update(deltaTime2, context) {
    if (!this.started) {
      return;
    }
    this.preUpdate(deltaTime2, context);
    for (const entity of this.entities) {
      if (entity.started) {
        entity.update(deltaTime2);
      }
    }
    this.postUpdate(deltaTime2, context);
  }
  preUpdate() {
  }
  postUpdate() {
