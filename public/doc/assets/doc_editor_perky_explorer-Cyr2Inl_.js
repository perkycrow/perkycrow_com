...
registerStageController_fn = function() {
  var _a;
  const ControllerClass = (_a = this.stage) == null ? void 0 : _a.constructor.ActionController;
  if (!ControllerClass) {
    return;
  }
...
unregisterStageController_fn = function() {
  var _a;
  if (!((_a = this.stage) == null ? void 0 : _a._controllerName)) {
    return;
  }
