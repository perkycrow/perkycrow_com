...
var _functionBindings, _stringBindings, _AutoView_instances, compileBindings_fn, _classRegistry, _matcherRegistry, _views, _WorldView_instances, bindWorldEvents_fn, handleEntitySet_fn, handleEntityDelete_fn, disposeAllViews_fn, resolveViews_fn;
  ...
  updateViews(deltaTime) {
    ...
    for (const views of __privateGet(this, _views).values()) {
      for (const view of views) {
        (_a = view.update) == null ? void 0 : _a.call(view, deltaTime);
      }
    }
  }
  syncViews() {
