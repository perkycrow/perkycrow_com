const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["./devtools_command_palette-0VzCSIBI.js","./spritesheet_viewer-C7jRwWG4.js","./shelf_packer-B9xAzSmX.js","./preload-helper-BbOs9S9B.js"])))=>i.map(i=>d[i]);
...
import { u as uniqueId, f as formatNumber$1, a as formatBytes, p as pluralize } from "./shelf_packer-B9xAzSmX.js";
import { P as PerkyModule, R as Registry, l as logger, c as createElement, N as Notifier, M as Manifest, S as SourceManager, a as loaders, C as Circle, b as Rectangle, d as Sprite, B as BaseRenderer, t as traverseAndCollect, W as WebGLRenderer, e as Camera, G as Group2D, O as Object2D, T as TextureSystem, E as Easing, f as ShaderEffect, g as SpriteAnimator, m as manifest, h as EditorComponent, I as ICONS, i as WebGLTextureManager, j as controlsSheet, k as handleAttributeChange, n as emitChange, o as RenderGroup, p as editorScrollbarStyles, q as editorButtonStyles, r as editorBaseStyles, s as editorHeaderStyles, u as createStyleSheet } from "./spritesheet_viewer-C7jRwWG4.js";
...
showCommandPalette_fn = async function() {
  if (!__privateGet(this, _commandPaletteEl)) {
    const { default: DevToolsCommandPalette } = await __vitePreload(async () => {
      const { default: DevToolsCommandPalette2 } = await import("./devtools_command_palette-0VzCSIBI.js");
