...
class Sprite extends Object2D {
  ...
  get image() {
    var _a2;
    return ((_a2 = __privateGet(this, _region)) == null ? void 0 : _a2.image) ?? null;
  }
  set image(value) {
    if (value) {
...
class PostProcessor extends PerkyModule {
  ...
  resize(width, height) {
    ...
    this.width = width;
    this.height = height;
    (_a2 = __privateGet(this, _framebufferManager)) == null ? void 0 : _a2.resize(width, height);
  }
  hasActivePasses() {
...
class TextureSystem extends PerkyModule {
  ...
  getRegion(id) {
    ...
    const source = (_a2 = this.fallback) == null ? void 0 : _a2.call(this, id);
    if (source) {
  ...
  addFromAsset(asset) {
    ...
    if (((_a2 = asset.config) == null ? void 0 : _a2.atlas) === false) {
  ...
  buildFromAssets(assets) {
    ...
    for (const asset of assets) {
      ...
      const atlasName = (_a2 = asset.config) == null ? void 0 : _a2.atlas;
      if (atlasName === false) {
...
class SpriteAnimator extends PerkyModule {
  ...
  resolveSourceFrames(source) {
    ...
    const spritesheet = (_a2 = this.textureSystem) == null ? void 0 : _a2.getSpritesheet(spritesheetName);
    if (!spritesheet) {
      return [];
    }
  ...
  resolveFrame(frameConfig) {
    ...
    if (frameConfig.region) {
      return {
        region: (_a2 = this.textureSystem) == null ? void 0 : _a2.getRegion(frameConfig.region),
  ...
  play(name) {
    ...
    (_a2 = this.current) == null ? void 0 : _a2.restart();
    return this.current;
  }
  get(name) {
    return this.getChild(name);
...
class BaseTreeNode extends BaseEditorComponent {
  ...
  get depth() {
    return __privateGet(this, _depth2);
  }
  get expanded() {
  ...
  setDepth(depth) {
    __privateSet(this, _depth2, depth);
  ...
  updateChildren() {
    ...
    for (const child of children) {
      ...
      childNode.setDepth(__privateGet(this, _depth2) + 1);
...
updateDepth_fn = function() {
  __privateGet(this, _contentEl).style.setProperty("--depth", __privateGet(this, _depth2));
};
...
createSection_fn2 = function(title, key, count = null) {
  ...
  const toggle = document.createElement("span");
  toggle.className = `section-toggle ${__privateGet(this, _sectionsState2)[key] ? "" : "collapsed"}`;
  toggle.textContent = "▼";
  header.appendChild(titleEl);
  header.appendChild(toggle);
  const content = document.createElement("div");
  content.className = `section-content ${__privateGet(this, _sectionsState2)[key] ? "" : "collapsed"}`;
  header.addEventListener("click", () => {
...
createHeader_fn3 = function() {
  ...
  __privateSet(this, _layersBtnEl, document.createElement("button"));
  __privateGet(this, _layersBtnEl).className = "explorer-btn explorer-btn-icon";
  __privateGet(this, _layersBtnEl).innerHTML = ICONS.layers;
...
const STYLES$a = buildEditorStyles(
...
const STYLES$9 = buildDockStyles();
...
createHeader_fn4 = function() {
  ...
  __privateSet(this, _actionsEl2, document.createElement("div"));
  __privateGet(this, _actionsEl2).className = "sidebar-actions";
...
const STYLES$8 = buildSidebarStyles();
...
const STYLES$7 = buildEditorStyles(
  editorScrollbarStyles,
  editorBaseStyles,
  `
    :host {
...
showCommandPalette_fn = async function() {
  if (!__privateGet(this, _commandPaletteEl)) {
    const { default: DevToolsCommandPalette } = await __vitePreload(async () => {
      const { default: DevToolsCommandPalette2 } = await import("./devtools_command_palette-DqBjamgC.js");
...
class ToolWindow extends BaseEditorComponent {
  constructor() {
    super(...arguments);
    ...
    __privateAdd(this, _x3, 20);
    __privateAdd(this, _y3, 20);
    __privateAdd(this, _width3, 450);
    __privateAdd(this, _height2, 350);
  ...
  connectedCallback() {
    __privateMethod(this, _ToolWindow_instances, buildDOM_fn16).call(this);
...
buildDOM_fn16 = function() {
  const style = document.createElement("style");
  style.textContent = STYLES$5;
  this.shadowRoot.appendChild(style);
  const container = document.createElement("div");
  container.className = "tool-window";
  __privateSet(this, _headerEl4, document.createElement("div"));
  __privateGet(this, _headerEl4).className = "tool-window-header";
  ...
  titleEl.textContent = __privateGet(this, _title);
  ...
  __privateSet(this, _contentEl5, document.createElement("div"));
  __privateGet(this, _contentEl5).className = "tool-window-content";
...
setupDrag_fn = function() {
  const startDrag = (e) => {
    ...
    __privateSet(this, _dragOffset, {
      x: coords.x - __privateGet(this, _x3),
      y: coords.y - __privateGet(this, _y3)
    });
    this.bringToFront();
  };
  __privateGet(this, _headerEl4).addEventListener("mousedown", startDrag);
  __privateGet(this, _headerEl4).addEventListener("touchstart", startDrag, { passive: true });
  __privateSet(this, _onPointerMove, (e) => {
    if (!__privateGet(this, _isDragging2) && !__privateGet(this, _isResizing)) {
      return;
    }
    const coords = getPointerCoords(e);
    if (__privateGet(this, _isDragging2)) {
      __privateSet(this, _x3, coords.x - __privateGet(this, _dragOffset).x);
      __privateSet(this, _y3, coords.y - __privateGet(this, _dragOffset).y);
      __privateMethod(this, _ToolWindow_instances, applyPosition_fn).call(this);
    }
    if (__privateGet(this, _isResizing)) {
      __privateSet(this, _width3, Math.max(__privateGet(this, _minWidth), coords.x - __privateGet(this, _x3)));
      __privateSet(this, _height2, Math.max(__privateGet(this, _minHeight), coords.y - __privateGet(this, _y3)));
      __privateMethod(this, _ToolWindow_instances, applyPosition_fn).call(this);
    }
  });
  ...
  window.addEventListener("mousemove", __privateGet(this, _onPointerMove));
  window.addEventListener("mouseup", __privateGet(this, _onPointerUp));
  window.addEventListener("touchmove", __privateGet(this, _onPointerMove), { passive: true });
  window.addEventListener("touchend", __privateGet(this, _onPointerUp));
};
...
cleanupWindowListeners_fn = function() {
  if (__privateGet(this, _onPointerMove)) {
    window.removeEventListener("mousemove", __privateGet(this, _onPointerMove));
    window.removeEventListener("touchmove", __privateGet(this, _onPointerMove));
  }
  if (__privateGet(this, _onPointerUp)) {
    window.removeEventListener("mouseup", __privateGet(this, _onPointerUp));
    window.removeEventListener("touchend", __privateGet(this, _onPointerUp));
  }
};
applyPosition_fn = function() {
  this.style.left = `${__privateGet(this, _x3)}px`;
  this.style.top = `${__privateGet(this, _y3)}px`;
  this.style.width = `${__privateGet(this, _width3)}px`;
  this.style.height = `${__privateGet(this, _height2)}px`;
};
...
const STYLES$5 = buildEditorStyles(
  editorBaseStyles,
  `
    :host {
        position: fixed;
...
class BaseFloatingTool extends BaseEditorComponent {
  constructor() {
    super(...arguments);
  ...
  static buildStyles(...customStyles2) {
    return buildEditorStyles(
      editorBaseStyles,
      editorScrollbarStyles,
      ...customStyles2
...
class FoobarTool extends BaseFloatingTool {
  constructor() {
    super(...arguments);
  ...
  connectedCallback() {
    __privateMethod(this, _FoobarTool_instances, buildDOM_fn17).call(this);
  }
  onParamsSet() {
...
buildDOM_fn17 = function() {
  const style = document.createElement("style");
  style.textContent = STYLES$4;
  this.shadowRoot.appendChild(style);
  __privateSet(this, _contentEl6, document.createElement("div"));
  __privateGet(this, _contentEl6).className = "foobar-content";
...
__publicField(FoobarTool, "toolId", "foobar");
__publicField(FoobarTool, "toolName", "Foobar Test");
__publicField(FoobarTool, "toolIcon", ICONS.flask);
__publicField(FoobarTool, "defaultWidth", 400);
__publicField(FoobarTool, "defaultHeight", 250);
const STYLES$4 = FoobarTool.buildStyles(`
    .foobar-content {
        color: var(--fg-primary);
        font-family: var(--font-mono);
        font-size: 12px;
...
class AnimationPreview extends BaseEditorComponent {
  ...
  connectedCallback() {
    __privateMethod(this, _AnimationPreview_instances, buildDOM_fn18).call(this);
  }
  disconnectedCallback() {
    this.stop();
  ...
  setAnimation(animation) {
    ...
    __privateMethod(this, _AnimationPreview_instances, render_fn5).call(this);
  }
  play() {
  ...
  pause() {
    ...
    (_a2 = __privateGet(this, _animation)) == null ? void 0 : _a2.pause();
  ...
  stop() {
    var _a2;
    this.pause();
    (_a2 = __privateGet(this, _animation)) == null ? void 0 : _a2.stop();
    __privateMethod(this, _AnimationPreview_instances, updateSprite_fn).call(this);
    __privateMethod(this, _AnimationPreview_instances, render_fn5).call(this);
  ...
  get currentIndex() {
    var _a2;
    return ((_a2 = __privateGet(this, _animation)) == null ? void 0 : _a2.currentIndex) ?? 0;
  }
  get isPlaying() {
...
buildDOM_fn18 = function() {
  ...
  __privateGet(this, _canvas2).width = 128;
  __privateGet(this, _canvas2).height = 128;
  container.appendChild(__privateGet(this, _canvas2));
...
setupRenderer_fn = function() {
  ...
  __privateGet(this, _renderer).camera.setUnitsInView({ width: 128, height: 128 });
...
updateSprite_fn = function() {
  ...
  if (frame == null ? void 0 : frame.region) {
    ...
    __privateMethod(this, _AnimationPreview_instances, fitCamera_fn).call(this, frame.region);
  }
};
fitCamera_fn = function(region) {
  if (!region || !__privateGet(this, _renderer)) {
    return;
  }
  ...
  __privateGet(this, _renderer).camera.setUnitsInView({ width: unitsInView, height: unitsInView });
};
...
const STYLES$3 = buildEditorStyles(
  editorBaseStyles,
  `
    :host {
        display: block;
...
class AnimationTimeline extends BaseEditorComponent {
  constructor() {
    ...
    __privateAdd(this, _containerEl7, null);
    ...
    __privateAdd(this, _dragSourceIndex, -1);
  }
  connectedCallback() {
    __privateMethod(this, _AnimationTimeline_instances, buildDOM_fn19).call(this);
    this.tabIndex = 0;
    this.addEventListener("keydown", (e) => __privateMethod(this, _AnimationTimeline_instances, handleKeydown_fn2).call(this, e));
  }
  setFrames(frames) {
    __privateSet(this, _frames, frames);
    __privateMethod(this, _AnimationTimeline_instances, render_fn6).call(this);
  }
  setCurrentIndex(index) {
  ...
  handleTouchDragOver(clientX) {
    __privateGet(this, _containerEl7).classList.add("drag-over");
    __privateSet(this, _dropIndex, __privateMethod(this, _AnimationTimeline_instances, calculateDropIndex_fn).call(this, clientX));
    __privateMethod(this, _AnimationTimeline_instances, updateDropIndicator_fn).call(this, "insert");
  }
  handleTouchDrop(frameData) {
    __privateGet(this, _containerEl7).classList.remove("drag-over");
...
_containerEl7 = new WeakMap();
_dropIndicator = new WeakMap();
_frames = new WeakMap();
_currentIndex = new WeakMap();
_dropIndex = new WeakMap();
_dragSourceIndex = new WeakMap();
_AnimationTimeline_instances = new WeakSet();
buildDOM_fn19 = function() {
  const style = document.createElement("style");
  style.textContent = STYLES$2;
  this.shadowRoot.appendChild(style);
  __privateSet(this, _containerEl7, document.createElement("div"));
  __privateGet(this, _containerEl7).className = "timeline";
  __privateSet(this, _dropIndicator, document.createElement("div"));
  __privateGet(this, _dropIndicator).className = "drop-indicator";
  __privateGet(this, _dropIndicator).innerHTML = '<div class="drop-label"></div>';
  __privateGet(this, _containerEl7).appendChild(__privateGet(this, _dropIndicator));
  __privateMethod(this, _AnimationTimeline_instances, setupDropZone_fn).call(this);
  this.shadowRoot.appendChild(__privateGet(this, _containerEl7));
};
setupDropZone_fn = function() {
  __privateGet(this, _containerEl7).addEventListener("dragover", (e) => {
    ...
    __privateMethod(this, _AnimationTimeline_instances, updateDropIndicator_fn).call(this, isTimelineDrag ? "move" : "insert");
  });
  __privateGet(this, _containerEl7).addEventListener("dragleave", (e) => {
    if (!__privateGet(this, _containerEl7).contains(e.relatedTarget)) {
      __privateGet(this, _containerEl7).classList.remove("drag-over");
      __privateMethod(this, _AnimationTimeline_instances, hideDropIndicator_fn).call(this);
    }
  });
  __privateGet(this, _containerEl7).addEventListener("drop", (e) => {
    e.preventDefault();
    __privateGet(this, _containerEl7).classList.remove("drag-over");
    const timelineData = e.dataTransfer.getData(DRAG_TYPE_TIMELINE);
    if (timelineData) {
      __privateMethod(this, _AnimationTimeline_instances, handleTimelineDrop_fn).call(this, timelineData);
      __privateMethod(this, _AnimationTimeline_instances, hideDropIndicator_fn).call(this);
      return;
    }
...
handleTimelineDrop_fn = function(data) {
  try {
    const { sourceIndex } = JSON.parse(data);
    if (sourceIndex === __privateGet(this, _dropIndex) || sourceIndex === __privateGet(this, _dropIndex) - 1) {
      return;
    }
    this.dispatchEvent(new CustomEvent("framemove", {
      detail: {
        fromIndex: sourceIndex,
        toIndex: __privateGet(this, _dropIndex)
      }
    }));
  } catch {
  }
...
calculateDropIndex_fn = function(clientX) {
  const frameEls = __privateGet(this, _containerEl7).querySelectorAll(".frame");
...
updateDropIndicator_fn = function(mode) {
  const frameEls = __privateGet(this, _containerEl7).querySelectorAll(".frame");
  __privateGet(this, _dropIndicator).classList.add("visible");
  __privateGet(this, _dropIndicator).dataset.mode = mode;
  const label = __privateGet(this, _dropIndicator).querySelector(".drop-label");
  label.textContent = __privateGet(this, _dropIndex);
  ...
  if (__privateGet(this, _dropIndex) >= frameEls.length) {
    ...
    const containerRect2 = __privateGet(this, _containerEl7).getBoundingClientRect();
    const frameRect2 = lastFrame.getBoundingClientRect();
    __privateGet(this, _dropIndicator).style.left = `${frameRect2.right - containerRect2.left + 2}px`;
    return;
  }
  const targetFrame = frameEls[__privateGet(this, _dropIndex)];
  const containerRect = __privateGet(this, _containerEl7).getBoundingClientRect();
  const frameRect = targetFrame.getBoundingClientRect();
  __privateGet(this, _dropIndicator).style.left = `${frameRect.left - containerRect.left - 2}px`;
};
hideDropIndicator_fn = function() {
  __privateGet(this, _dropIndicator).classList.remove("visible");
  delete __privateGet(this, _dropIndicator).dataset.mode;
  __privateSet(this, _dropIndex, -1);
};
render_fn6 = function() {
  __privateGet(this, _containerEl7).innerHTML = "";
  __privateSet(this, _dropIndicator, document.createElement("div"));
  __privateGet(this, _dropIndicator).className = "drop-indicator";
  __privateGet(this, _dropIndicator).innerHTML = '<div class="drop-label"></div>';
  __privateGet(this, _containerEl7).appendChild(__privateGet(this, _dropIndicator));
  for (let i = 0; i < __privateGet(this, _frames).length; i++) {
    ...
    __privateGet(this, _containerEl7).appendChild(frameEl);
  }
  __privateMethod(this, _AnimationTimeline_instances, updateHighlight_fn).call(this);
};
createFrameElement_fn = function(frame, index) {
  ...
  deleteBtn.addEventListener("click", (e) => {
    e.stopPropagation();
    __privateMethod(this, _AnimationTimeline_instances, dispatchDeleteEvent_fn).call(this, index);
  });
  ...
  frameEl.addEventListener("dragstart", (e) => {
    __privateSet(this, _dragSourceIndex, index);
  ...
  frameEl.addEventListener("dragend", () => {
    __privateSet(this, _dragSourceIndex, -1);
...
updateHighlight_fn = function() {
  ...
  frameEls.forEach((el, i) => {
    el.classList.toggle("active", i === __privateGet(this, _currentIndex));
  });
};
...
class SpritesheetViewer extends BaseEditorComponent {
  constructor() {
    ...
    __privateAdd(this, _containerEl8, null);
    __privateAdd(this, _filterEl, null);
    __privateAdd(this, _gridEl2, null);
    __privateAdd(this, _spritesheet, null);
    __privateAdd(this, _filter, null);
    __privateAdd(this, _animationColorMap, /* @__PURE__ */ new Map());
    __privateAdd(this, _touchDragData, null);
    __privateAdd(this, _touchDragGhost, null);
    __privateAdd(this, _touchStartPos, null);
    __privateAdd(this, _touchStartEl, null);
    __privateAdd(this, _lastTimeline, null);
    __privateAdd(this, _boundTouchMove, null);
    __privateAdd(this, _boundTouchEnd, null);
  }
  connectedCallback() {
    __privateMethod(this, _SpritesheetViewer_instances, buildDOM_fn20).call(this);
    __privateMethod(this, _SpritesheetViewer_instances, setupTouchDrag_fn).call(this);
  }
  disconnectedCallback() {
    __privateMethod(this, _SpritesheetViewer_instances, cleanupTouchDrag_fn).call(this);
  }
...
_containerEl8 = new WeakMap();
_filterEl = new WeakMap();
_gridEl2 = new WeakMap();
_spritesheet = new WeakMap();
_filter = new WeakMap();
_animationColorMap = new WeakMap();
_touchDragData = new WeakMap();
_touchDragGhost = new WeakMap();
_touchStartPos = new WeakMap();
_touchStartEl = new WeakMap();
_lastTimeline = new WeakMap();
_SpritesheetViewer_instances = new WeakSet();
buildDOM_fn20 = function() {
  const style = document.createElement("style");
  style.textContent = STYLES$1;
  this.shadowRoot.appendChild(style);
  __privateSet(this, _containerEl8, document.createElement("div"));
  __privateGet(this, _containerEl8).className = "viewer-container";
  ...
  __privateSet(this, _gridEl2, document.createElement("div"));
  __privateGet(this, _gridEl2).className = "frame-grid";
  __privateGet(this, _containerEl8).appendChild(__privateGet(this, _filterEl));
  __privateGet(this, _containerEl8).appendChild(__privateGet(this, _gridEl2));
  this.shadowRoot.appendChild(__privateGet(this, _containerEl8));
};
...
renderGrid_fn = function() {
  __privateGet(this, _gridEl2).innerHTML = "";
  if (!__privateGet(this, _spritesheet)) {
    return;
  }
  ...
  for (const [name, frameData] of frames) {
    ...
    __privateGet(this, _gridEl2).appendChild(frameEl);
  }
};
...
createFrameElement_fn2 = function(name, frameData) {
  ...
  frameEl.addEventListener("dragstart", (e) => {
    ...
    e.dataTransfer.setData("application/x-spritesheet-frame", JSON.stringify({
      name,
      regionData: {
        x: (_a2 = frameData.region) == null ? void 0 : _a2.x,
...
setupTouchDrag_fn = function() {
  this.addEventListener("touchstart", (e) => __privateMethod(this, _SpritesheetViewer_instances, onTouchStart_fn).call(this, e), { passive: false });
  __privateSet(this, _boundTouchMove, (e) => __privateMethod(this, _SpritesheetViewer_instances, onTouchMove_fn).call(this, e));
  __privateSet(this, _boundTouchEnd, (e) => __privateMethod(this, _SpritesheetViewer_instances, onTouchEnd_fn).call(this, e));
  document.addEventListener("touchmove", __privateGet(this, _boundTouchMove), { passive: false });
  document.addEventListener("touchend", __privateGet(this, _boundTouchEnd));
};
_boundTouchMove = new WeakMap();
_boundTouchEnd = new WeakMap();
cleanupTouchDrag_fn = function() {
  if (__privateGet(this, _boundTouchMove)) {
    document.removeEventListener("touchmove", __privateGet(this, _boundTouchMove));
  }
  if (__privateGet(this, _boundTouchEnd)) {
    document.removeEventListener("touchend", __privateGet(this, _boundTouchEnd));
  }
...
onTouchStart_fn = function(e) {
  ...
  const frameEl = ((_a2 = target.closest) == null ? void 0 : _a2.call(target, ".frame")) || __privateMethod(this, _SpritesheetViewer_instances, findFrameFromPoint_fn).call(this, touch.clientX, touch.clientY);
  if (!frameEl) {
    return;
  }
  __privateSet(this, _touchStartPos, { x: touch.clientX, y: touch.clientY });
  __privateSet(this, _touchStartEl, frameEl);
  __privateSet(this, _touchDragData, null);
};
findFrameFromPoint_fn = function(x, y) {
  var _a2;
  const elements = this.shadowRoot.elementsFromPoint(x, y);
  for (const el of elements) {
    if ((_a2 = el.classList) == null ? void 0 : _a2.contains("frame")) {
      return el;
    }
  }
  return null;
...
onTouchMove_fn = function(e) {
  if (!__privateGet(this, _touchStartEl)) {
    return;
  }
  const touch = e.touches[0];
  const dx = touch.clientX - __privateGet(this, _touchStartPos).x;
  const dy = touch.clientY - __privateGet(this, _touchStartPos).y;
  const distance = Math.sqrt(dx * dx + dy * dy);
  if (!__privateGet(this, _touchDragData) && distance > 10) {
    e.preventDefault();
    __privateMethod(this, _SpritesheetViewer_instances, startTouchDrag_fn).call(this, touch);
  }
  if (__privateGet(this, _touchDragData)) {
    e.preventDefault();
    __privateMethod(this, _SpritesheetViewer_instances, updateDragGhost_fn).call(this, touch.clientX, touch.clientY);
...
onTouchEnd_fn = function(e) {
  ...
  if (__privateGet(this, _touchDragData)) {
    ...
    const timeline = findTimeline(touch.clientX, touch.clientY);
    if (timeline) {
      timeline.handleTouchDrop(__privateGet(this, _touchDragData));
    } else if (__privateGet(this, _lastTimeline)) {
      __privateGet(this, _lastTimeline).handleTouchDragLeave();
    }
    (_a2 = __privateGet(this, _touchStartEl)) == null ? void 0 : _a2.classList.remove("dragging");
    __privateMethod(this, _SpritesheetViewer_instances, removeDragGhost_fn).call(this);
  }
  __privateSet(this, _touchStartPos, null);
  __privateSet(this, _touchStartEl, null);
  __privateSet(this, _touchDragData, null);
  __privateSet(this, _lastTimeline, null);
};
startTouchDrag_fn = function(touch) {
  var _a2, _b, _c, _d, _e;
  const frameEl = __privateGet(this, _touchStartEl);
  const name = frameEl.dataset.name;
  const frameData = (_a2 = __privateGet(this, _spritesheet)) == null ? void 0 : _a2.framesMap.get(name);
  if (!frameData) {
    return;
  }
  __privateSet(this, _touchDragData, {
    name,
    regionData: {
  ...
  frameEl.classList.add("dragging");
  __privateMethod(this, _SpritesheetViewer_instances, createDragGhost_fn).call(this, frameEl, touch.clientX, touch.clientY);
};
createDragGhost_fn = function(frameEl, x, y) {
  ...
  __privateSet(this, _touchDragGhost, document.createElement("div"));
  __privateGet(this, _touchDragGhost).className = "touch-drag-ghost";
  __privateGet(this, _touchDragGhost).style.cssText = `
            position: fixed;
            pointer-events: none;
            z-index: 10000;
            opacity: 0.8;
  ...
  __privateGet(this, _touchDragGhost).appendChild(clonedCanvas);
  document.body.appendChild(__privateGet(this, _touchDragGhost));
  __privateMethod(this, _SpritesheetViewer_instances, updateDragGhost_fn).call(this, x, y);
};
updateDragGhost_fn = function(x, y) {
  if (__privateGet(this, _touchDragGhost)) {
    __privateGet(this, _touchDragGhost).style.left = `${x}px`;
    __privateGet(this, _touchDragGhost).style.top = `${y}px`;
  }
};
removeDragGhost_fn = function() {
  if (__privateGet(this, _touchDragGhost)) {
    __privateGet(this, _touchDragGhost).remove();
    __privateSet(this, _touchDragGhost, null);
  }
};
...
function findElementInShadowDom({ root, x, y, tagName, visited }) {
  ...
  for (const el of elements) {
    ...
    visited.add(el);
    if (((_a2 = el.tagName) == null ? void 0 : _a2.toLowerCase()) === tagName) {
      return el;
    }
    if (el.shadowRoot) {
...
class SpriteAnimatorTool extends BaseFloatingTool {
  constructor() {
    super(...arguments);
  ...
  connectedCallback() {
    __privateMethod(this, _SpriteAnimatorTool_instances, buildDOM_fn21).call(this);
  }
  onOptionsSet() {
  ...
  onParamsSet() {
    ...
    const resolvedClass = animatorClass || __privateMethod(this, _SpriteAnimatorTool_instances, getDefaultAnimatorClass_fn).call(this);
    __privateMethod(this, _SpriteAnimatorTool_instances, selectAnimatorClass_fn).call(this, resolvedClass, { animator, spritesheet });
  }
}
...
buildDOM_fn21 = function() {
  const style = document.createElement("style");
  style.textContent = STYLES;
  this.shadowRoot.appendChild(style);
  __privateSet(this, _contentEl7, document.createElement("div"));
  __privateGet(this, _contentEl7).className = "animator-content";
  this.shadowRoot.appendChild(__privateGet(this, _contentEl7));
  __privateMethod(this, _SpriteAnimatorTool_instances, render_fn7).call(this);
};
getDefaultAnimatorClass_fn = function() {
  const animatorNames = Object.keys(__privateGet(this, _animators));
  return animatorNames.length > 0 ? __privateGet(this, _animators)[animatorNames[0]] : null;
};
selectAnimatorClass_fn = function(animatorClass, { animator, spritesheet } = {}) {
  const { textureSystem } = this.params;
  __privateSet(this, _animatorClass, animatorClass || null);
  if (animator) {
    __privateSet(this, _animator, animator);
    ...
    __privateSet(this, _animator, null);
  }
  if (spritesheet) {
    __privateSet(this, _spritesheet2, spritesheet);
  } else if (animatorClass && textureSystem) {
    const spritesheetName = __privateMethod(this, _SpriteAnimatorTool_instances, inferSpritesheetName_fn).call(this);
    __privateSet(this, _spritesheet2, spritesheetName ? textureSystem.getSpritesheet(spritesheetName) : null);
  } else {
    __privateSet(this, _spritesheet2, null);
  }
...
inferSpritesheetName_fn = function() {
  var _a2, _b, _c;
  const animations = (_a2 = __privateGet(this, _animatorClass)) == null ? void 0 : _a2.animations;
  if (!animations) {
    return null;
  }
...
setupAnimatorSelect_fn = function() {
  ...
  for (const [name, AnimatorClass] of Object.entries(__privateGet(this, _animators))) {
    const option = document.createElement("option");
    option.value = name;
    option.textContent = name;
    option.selected = AnimatorClass === __privateGet(this, _animatorClass);
    select.appendChild(option);
  }
  select.addEventListener("change", (e) => {
    const AnimatorClass = __privateGet(this, _animators)[e.target.value];
    __privateMethod(this, _SpriteAnimatorTool_instances, selectAnimatorClass_fn).call(this, AnimatorClass);
  });
};
...
buildAnimationConfig_fn = function(anim) {
  ...
  config.frames = anim.frames.map((frame) => {
    ...
    if (frame.source) {
      ...
      frameConfig.source = `${((_a2 = __privateGet(this, _spritesheet2)) == null ? void 0 : _a2.$id) || "spritesheet"}:${frame.name}`;
    }
    if (frame.duration && frame.duration !== 1) {
...
setupSpritesheetViewer_fn = function() {
  ...
  if (__privateGet(this, _spritesheet2)) {
    __privateGet(this, _spritesheetViewerEl).setSpritesheet(__privateGet(this, _spritesheet2));
  }
};
__publicField(SpriteAnimatorTool, "toolId", "spriteAnimator");
__publicField(SpriteAnimatorTool, "toolName", "Sprite Animator");
__publicField(SpriteAnimatorTool, "toolIcon", ICONS.clapperboard);
__publicField(SpriteAnimatorTool, "defaultWidth", 600);
__publicField(SpriteAnimatorTool, "defaultHeight", 450);
