const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["./devtools_command_palette-Cbm2l-eJ.js","./perky_store-CSYJ9bT0.js","./preload-helper-DNpi5zPU.js","./spritesheet_viewer-B3_sTZdE.js"])))=>i.map(i=>d[i]);
...
import { l as logger, c as createElement, u as uniqueId, N as Notifier, f as formatNumber$1, a as formatBytes, p as pluralize, _ as __vitePreload, b as createStyleSheet } from "./preload-helper-DNpi5zPU.js";
import { P as PerkyModule, R as Registry, M as Manifest, S as SourceManager, l as loaders, T as TextureSystem, m as manifestData, E as EditorComponent, I as ICONS, e as editorScrollbarStyles, a as editorButtonStyles, b as editorBaseStyles, c as editorHeaderStyles, d as PerkyStore } from "./perky_store-CSYJ9bT0.js";
import { C as Circle, R as Rectangle, S as Sprite, B as BaseRenderer, t as traverseAndCollect, W as WebGLRenderer, a as Camera, G as Group2D, O as Object2D, E as Easing, b as ShaderEffect, c as SpriteAnimator, d as WebGLTextureManager, e as controlsSheet, h as handleAttributeChange, f as emitChange, g as RenderGroup } from "./spritesheet_viewer-B3_sTZdE.js";
...
showCommandPalette_fn = async function() {
  if (!__privateGet(this, _commandPaletteEl)) {
    const { default: DevToolsCommandPalette } = await __vitePreload(async () => {
      const { default: DevToolsCommandPalette2 } = await import("./devtools_command_palette-Cbm2l-eJ.js");
