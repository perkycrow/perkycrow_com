...
registerStageController_fn = function() {
  var _a2;
  const ControllerClass = (_a2 = this.stage) == null ? void 0 : _a2.constructor.ActionController;
  if (!ControllerClass) {
    return;
  }
  const controller = this.registerController(ControllerClass);
...
onUpdate_fn = function(deltaTime) {
  ...
  (_a2 = this.stage) == null ? void 0 : _a2.update(deltaTime);
...
class WaveSystem extends PerkyModule {
  constructor(options = {}) {
    ...
    __publicField(this, "nextSpawnTime", 0);
  ...
  update(delta) {
    ...
    if (this.isSpawning) {
      ...
      __privateMethod(this, _WaveSystem_instances, updateSpawning_fn).call(this, delta);
    }
    this.emit("tick", {
      wave: this.wave,
      day: this.day,
...
updateSpawning_fn = function(delta) {
  if (!this.world) {
    return;
  }
  ...
  const config = __privateMethod(this, _WaveSystem_instances, getSpawnConfig_fn).call(this);
  this.spawnTimer = 0;
  this.nextSpawnTime = __privateMethod(this, _WaveSystem_instances, getNextSpawnTime_fn).call(this);
...
startNextWave_fn = function() {
  ...
  if (nextWave >= this.wavesPerDay) {
    ...
    this.wave = nextWave;
    this.elapsedTime = 0;
    __privateMethod(this, _WaveSystem_instances, initWaveSpawn_fn).call(this);
...
__publicField(WaveSystem, "waveSettings", {
  baseEnemySpeed: 0.4,
...
__publicField(WaveSystem, "waveSpawnRatios", [
...
class GameplayStage extends DenStage {
  ...
  onStart() {
    super.onStart();
    __privateMethod(this, _GameplayStage_instances, createWaveSystem_fn).call(this);
    __privateMethod(this, _GameplayStage_instances, wireWaveSystemEvents_fn).call(this);
    __privateMethod(this, _GameplayStage_instances, wireWorldEvents_fn).call(this);
    __privateMethod(this, _GameplayStage_instances, createUI_fn).call(this);
...
_GameplayStage_instances = new WeakSet();
createWaveSystem_fn = function() {
  this.waveSystem = this.create(WaveSystem, {
    $bind: "waveSystem",
    world: this.world
  });
};
wireWaveSystemEvents_fn = function() {
...
setTimeOfDay_fn = function(value) {
  var _a2, _b, _c;
  (_b = (_a2 = this.stage) == null ? void 0 : _a2.dayNightPass) == null ? void 0 : _b.setProgress(value);
  (_c = this.stage) == null ? void 0 : _c.updateShadows(value);
};
...
class PreviewStage extends DenStage {
  ...
  onStart() {
    super.onStart();
    __privateMethod(this, _PreviewStage_instances, createUI_fn2).call(this);
  }
}
_PreviewStage_instances = new WeakSet();
createUI_fn2 = function() {
  const uiLayer = this.game.getHTML("ui");
...
__publicField(DefendTheDen, "ActionController", null);
...
renderExpanded_fn = function() {
  ...
  __privateGet(this, _dockEl).appendChild(studioButton);
...
function applyOverrides(manifestData2, overrides) {
  const assets = { ...manifestData2.assets };
  for (const { id, source } of overrides) {
    if (assets[id]) {
      assets[id] = { ...assets[id], source };
    }
  }
  return { ...manifestData2, assets };
}
