const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["./devtools_command_palette-BQXFa0X7.js","./perky_store-C6_wT1fL.js","./preload-helper-CeD19KcA.js","./spritesheet_viewer-e3Yq6yFI.js"])))=>i.map(i=>d[i]);
...
showCommandPalette_fn = async function() {
  if (!__privateGet(this, _commandPaletteEl)) {
    const { default: DevToolsCommandPalette } = await __vitePreload(async () => {
      const { default: DevToolsCommandPalette2 } = await import("./devtools_command_palette-BQXFa0X7.js");
