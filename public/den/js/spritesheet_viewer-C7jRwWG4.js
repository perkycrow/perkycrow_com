...
import { d as delegateProperties, u as uniqueId, t as toSnakeCase, s as setDefaults, b as deepMerge, g as getNestedValue, c as setNestedValue, e as toKebabCase, S as ShelfPacker } from "./shelf_packer-B9xAzSmX.js";
class Notifier {
  constructor() {
...
setup_fn = function() {
  __privateSet(this, _camera, new Camera({
    viewportWidth: __privateGet(this, _canvas2).width,
    viewportHeight: __privateGet(this, _canvas2).height
  }));
...
class AnimationPreview extends EditorComponent {
  constructor() {
    ...
    __privateAdd(this, _canvas3, null);
  ...
  setAnimation(animation) {
    ...
    if (!__privateGet(this, _renderer2) && __privateGet(this, _canvas3)) {
...
buildDOM_fn4 = function() {
  ...
  __privateSet(this, _canvas3, createElement("canvas", { class: "preview-canvas" }));
  __privateGet(this, _canvas3).width = 256;
  __privateGet(this, _canvas3).height = 256;
  __privateGet(this, _previewArea).appendChild(__privateGet(this, _canvas3));
...
syncPreviewVisibility_fn = function() {
  var _a;
  if (!__privateGet(this, _canvas3) || !__privateGet(this, _gamePreviewCanvas) || !__privateGet(this, _sceneryCanvas)) {
    return;
  }
  ...
  __privateGet(this, _canvas3).style.display = useGame ? "none" : "";
...
setupRenderer_fn = function() {
  __privateSet(this, _renderer2, new WebGLRenderer({
    canvas: __privateGet(this, _canvas3),
    backgroundColor: "transparent",
    width: 256,
    height: 256
  }));
...
getSpriteSize_fn = function() {
  ...
  if (!region || !__privateGet(this, _canvas3)) {
    return { width: 64, height: 64 };
  }
  const canvasRect = __privateGet(this, _canvas3).getBoundingClientRect();
...
updateSpritePosition_fn = function() {
  ...
  if (!__privateGet(this, _AnimationPreview_instances, sceneryActive_get) || !__privateGet(this, _moveSpriteMode)) {
    __privateGet(this, _canvas3).style.position = "";
    __privateGet(this, _canvas3).style.left = "";
    __privateGet(this, _canvas3).style.top = "";
    return;
  }
  ...
  __privateGet(this, _canvas3).style.position = "absolute";
  __privateGet(this, _canvas3).style.left = `${sceneryLeft + __privateGet(this, _spriteOffset)}px`;
  __privateGet(this, _canvas3).style.top = `${centerY}px`;
};
...
export {
  ...
  ShaderEffect as f,
  SpriteAnimator as g,
  EditorComponent as h,
  WebGLTextureManager as i,
  controlsSheet as j,
  handleAttributeChange as k,
  logger as l,
  manifest as m,
  emitChange as n,
  RenderGroup as o,
  editorScrollbarStyles as p,
  editorButtonStyles as q,
  editorBaseStyles as r,
  editorHeaderStyles as s,
  traverseAndCollect as t,
  createStyleSheet as u,
  adoptStyleSheets as v,
  TextureRegion as w
};
